...
import in.tt.tt17.fragments.AboutUsFragment;
import in.tt.tt17.fragments.CategoriesFragment;
import in.tt.tt17.fragments.DevelopersFragment;
import in.tt.tt17.fragments.EventsFragment;
import in.tt.tt17.fragments.FavouritesFragment;
import in.tt.tt17.fragments.HomeFragment;
import in.tt.tt17.fragments.OnlineEventsFragment;
import in.tt.tt17.fragments.ResultsFragment;
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (drawerView.getMenu().getItem(0).isChecked() &&  navigation.getMenu().getItem(0).isChecked() ){
                ...
                if(TT17.searchOpen ==1 && drawerView.getMenu().getItem(0).isChecked()){
                    fm.beginTransaction().replace(R.id.main_frame_layout, new CategoriesFragment()).commit();
                    TT17.searchOpen =0;
                }
                if(TT17.searchOpen ==2 && drawerView.getMenu().getItem(0).isChecked()){
